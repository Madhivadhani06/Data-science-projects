...
df = pd.read_csv("C:\\Users\\MADHIVADHANI\\Downloads\\final.csv")

class App:
    def model(self):
        # Setting Page Configuration
        st.set_page_config(page_title="Flat resale prediction | By Madhivadhani", layout="wide")
        ...
        if selected == "Flat resale_Prediction":
            ...
            with col2:
                ...
                with open("C:\\Users\\MADHIVADHANI\\Downloads\\S1_regression.pkl", 'rb') as f:
                    model = pickle.load(f)
        ...
        if selected == "Contact":
            col1, col2, col3 = st.columns([4, 10, 2])
            with col2:
                Name = (f'{"Name :"} {"Madhivadhani"}')
                mail = (f'{"Mail :"} {"madhivadhani06@gmail.com"}')
