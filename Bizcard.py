...
mydb = mysql.connector.connect(
    user='root',
    host='localhost',
    password='madhi@123', auth_plugin='mysql_native_password')
...
icon = Image.open("C:\\Users\\MADHIVADHANI\\Desktop\\business card.jfif")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By Madhivadhani",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *Madhivadhani*!"""})
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open("C:\\Users\\MADHIVADHANI\\Desktop\\business card.jfif"), width=500)
