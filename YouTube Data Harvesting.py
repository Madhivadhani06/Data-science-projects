...
icon = Image.open('C:\\Users\\MADHIVADHANI\\Desktop\\Youtube_logo.png')
st.set_page_config(page_title= "Youtube Data Harvesting and Warehousing | By madhivadhani",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This app is created by madhivadhini*!*"""})

# CREATING OPTION MENU
SELECT = option_menu(
    menu_title=None,
    options=["Home", "Extract & Transform", "View"],
    icons=["house-door-fill", "Tools", "Card_text"],
    default_index=2,
...
# HOME PAGE
if SELECT == "Home":
    st.title("Youtube Data Harvesting Using Mongodb, Mysql, Python, Streamlit")
    st.write(
