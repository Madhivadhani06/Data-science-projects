...
with tab1:
    ...
    if submit_button and flag == 0:
        ...
        with open(r"C:\\Users\\MADHIVADHANI\\Desktop\\model.pkl", 'rb') as file:
            loaded_model = pickle.load(file)
        with open(r"C:\\Users\\MADHIVADHANI\\Desktop\\scaler.pkl", 'rb') as f:
            scaler_loaded = pickle.load(f)

        with open(r"C:\\Users\\MADHIVADHANI\\Desktop\\t.pkl", 'rb') as f:
            t_loaded = pickle.load(f)

        with open(r"C:\\Users\\MADHIVADHANI\\Desktop\\s.pkl", 'rb') as f:
...
with tab2:
    ...
    if csubmit_button and cflag == 0:
        ...
        with open(r"C:\\Users\\MADHIVADHANI\\Desktop\\cmodel.pkl", 'rb') as file:
            cloaded_model = pickle.load(file)

        with open(r"C:\\Users\\MADHIVADHANI\\Desktop\\cscaler.pkl", 'rb') as f:
            cscaler_loaded = pickle.load(f)

        with open(r"C:\\Users\\MADHIVADHANI\\Desktop\\ct.pkl", 'rb') as f:
...
st.write(f'<h6 style="color:#ee4647;">App Created by Madhivadhani</h6>', unsafe_allow_html=True)
